...
int IcoSphere::getMiddlePoint(int index0, int index1)
{
	...
	long long int smallerIndex = isFirstSmaller ? index0 : index1;
	long long int largerIndex = isFirstSmaller ? index1 : index0;
	long long int key = (smallerIndex << 32) | largerIndex;
